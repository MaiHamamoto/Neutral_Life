...
/*
 * ファイルパス : /Applications/MAMP/htdocs/DT/shopping/lib/Cart.class.php
...
class Cart
{
    ...
    // カートに登録する(必要な情報は、誰が$mem_id、何を($item_id))
    ...
    // カートに登録する(必要な情報は、誰が$mem_id、何を($item_id))
    public function insCartDataExtend($mem_id, $item_id, $amount)
    {
        $table = ' cart ';
        $insData = [
            'mem_id' => $mem_id,
    ...
    // カートの情報を取得する(必要な情報は、誰が$mem_id。必要な商品情報は名前、商品画像、金額)
